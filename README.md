# Cargo — Company Profile Website

Static marketing site for **CargoPro** ("Speed You Can Trust"), built with
...
- `src/config/site.ts` — brand + contact details (single source of truth).
